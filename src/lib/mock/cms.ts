  ...
  reviews: [
    {
      ...
      country: "China",
      quote: L(
        "雖然因為店家疏忽記錯時間讓我等了20分鐘，但整體體驗很好。導遊的英文可以溝通，行程就是開卡丁車去各個大阪景點拍照，不過要注意並不會進入大阪城裡面，只會在遠處拍攝。建議可以安排在行程的第一天去兜風。而且其他家的卡丁車都是柴油車，味道很重，這家用的是電動車，沒有這個問題。開在路上就是全場焦點，遊客和當地人都會一直說很酷，拿手機拍你或者跟你揮手打招呼。交通非常安全，不用擔心，導遊也會適當地用手勢提示你。",
        "The shop mixed up the time and I waited 20 minutes, but the overall experience was still great. The guide's English was enough to communicate. The tour is driving a go-kart around Osaka sights for photos — note that you don't go inside Osaka Castle, you only shoot it from a distance. I'd put this on day one of the trip. Other karts are diesel and smell strongly; this shop uses electric karts, so that isn't an issue. On the road you're the center of attention — tourists and locals keep saying it's cool, taking photos or waving. Traffic felt very safe, and the guide cues you with hand signals.",
        "お店の手違いで時間を間違えられ20分待たされましたが、全体の体験はとても良かったです。ガイドの英語で十分やり取りできました。カートで大阪の名所を回って写真を撮るコースで、大阪城の中には入らず遠景で撮る点だけ注意です。旅行初日に入れるのがおすすめ。他社はディーゼルで排気の臭いが強いですが、こちらは電動なのでその心配がありません。走っていると注目の的で、観光客も地元の人も『かっこいい』と写真を撮ったり手を振ったりしてくれます。交通はとても安全で、ガイドが手信号で適切に合図してくれます。",
        "가게에서 시간을 잘못 적어 20분을 기다리긴 했지만, 전체 경험은 아주 좋았습니다. 가이드 영어로 소통할 수 있었고, 코스는 고카트를 타고 오사카 명소를 돌며 사진을 찍는 방식입니다. 오사카성 안에는 들어가지 않고 멀리서만 찍으니 참고하세요. 여행 첫째 날에 넣는 걸 추천합니다. 다른 곳은 디젤이라 냄새가 심한데, 여기는 전기 카트라 그 문제가 없습니다. 도로 위에서는 시선이 집중되고, 관광객과 현지인이 멋있다고 사진을 찍거나 손을 흔듭니다. 교통은 매우 안전하고, 가이드가 손짓으로 적절히 알려줍니다.",
      ),
    ...
    },
    {
      ...
      country: "Taiwan",
      quote: L(
        "店家非常好，講得非常仔細。再這麼冷的冬天看到我們沒有手套還主動提供手套跟暖暖包，一路上都會主動把我們拍照，而且照片都很漂亮，還特別帶我們去景點拍照走走，雖然短短一個小時，但非常值得又好玩！還有免費的衣服可以穿可以裝扮拍照非常好看，衣服包包就放在置物櫃，而且這一家是電動車不會有油耗味電動車也非常的有利身在其境的感覺",
        "The staff were wonderful and explained everything in detail. It was a freezing winter day and when they saw we had no gloves they offered gloves and heat packs. They kept taking photos of us the whole way, and the shots came out beautiful. They even took us to sights to walk around and pose. It was only an hour, but so worth it and so much fun! There are free costumes to wear for photos — they look great. Clothes and bags go in a locker. This shop uses electric karts so there's no petrol smell, and it really feels like you're in the moment.",
        "スタッフがとても良く、説明も丁寧でした。真冬で手袋がなく、進んで手袋とカイロを用意してくれました。途中ずっと写真を撮ってくれ、どれも綺麗。名所にも寄って歩いて撮らせてくれました。1時間と短いのに、すごく価値があって楽しい！無料の衣装で変身して撮れて見た目も最高。服とバッグはロッカーへ。電動カートなのでガソリン臭がなく、その場にいる感覚がよく味わえます。",
        "사장님이 정말 좋고 설명을 아주 자세히 해 주었습니다. 추운 겨울인데 장갑이 없는 걸 보고 장갑과 핫팩을 먼저 챙겨 주었습니다. 가는 내내 사진을 찍어 주었고 결과도 예뻤으며, 명소에 들러 걷고 찍을 시간도 만들어 주었습니다. 한 시간밖에 안 됐지만 정말 가치 있고 재미있었습니다! 무료 의상으로 변장해 찍으면 사진이 잘 나옵니다. 옷과 가방은 사물함에 두면 됩니다. 전기 카트라 기름 냄새도 없고 현장에 있는 느낌이 살아 있습니다.",
      ),
      photo: "/images/reviews/r3.webp",
      platform: "KKday",
      url: "https://www.hyperair.com/zh-TW/things-to-do/2535843",
      rating: 5,
      active: true,
      sort: 3,
    },
