...
const zh: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/plans": { title: "套餐管理", lead: "编辑套餐。附加项在编辑弹窗里添加、删除；打开内置后该项锁定，前台直接列出。" },
  ...
  plans: {
    ...
    distance: "距离（公里）",
    addons: "可购附加项",
    addonsHint: "勾选表示可加购。打开内置后自动取消勾选并锁定该行，前台直接列出。可在此添加或删除附加项。",
    listed: "上架",
    unfilled: "未填写",
    notUploaded: "尚未上传",
    minutes: "分钟",
  ...
  cms: {
    ...
    logo: "网站 Logo",
    logoHint: "建议上传透明底文字标，正方形或横版。不上传则前台继续显示文字标。",
    logoEmpty: "点击右侧上传 Logo",
    logoUpload: "上传 Logo",
    logoChange: "更换 Logo",
    logoRemove: "移除，改用文字标",
    phone: "电话",
...
const en: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/inventory": { title: "Inventory", lead: "Click a cell to see holds, book, or lock the slot." },
    "/admin/vehicles": { title: "Vehicles", lead: "10 karts. Units in repair are pulled from that day’s sellable stock." },
    "/admin/plans": { title: "Plans", lead: "Edit plans. Add or remove add-ons in the editor. Included items lock and list with the plan." },
    "/admin/addons": { title: "Add-ons", lead: "Edit name, price, description, quantity cap, and listing status." },
  ...
  plans: {
    ...
    addons: "Add-ons",
    addonsHint: "Check to sell as an extra. Turning on Included unchecks and locks the row. Add or remove add-ons here.",
    listed: "Listed",
    unfilled: "Empty",
  ...
  cms: {
    ...
    logo: "Site logo",
    logoHint: "Use a transparent wordmark, square or landscape. The text mark stays if you do not upload one.",
    logoEmpty: "Upload a logo on the right",
    logoUpload: "Upload logo",
    logoChange: "Replace logo",
    logoRemove: "Remove and use the text mark",
    phone: "Phone",
    email: "Email",
    hours: "Hours",
...
const ja: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/inventory": { title: "在庫管理", lead: "マスをクリックして内訳を確認。予約追加や枠ロックができます。" },
    "/admin/vehicles": { title: "車両管理", lead: "整備中の車両は当日の販売在庫から除外されます。" },
    "/admin/plans": { title: "コース管理", lead: "コースを編集します。オプションの追加・削除は編集画面で行います。セットに含むをオンにすると行がロックされます。" },
    "/admin/addons": { title: "オプション管理", lead: "名称・価格・説明・数量上限・公開状態を編集できます。" },
  ...
  plans: {
    ...
    distance: "距離（km）",
    addons: "選択可能なオプション",
    addonsHint: "チェックは追加購入用。セットに含むをオンにするとチェックが外れ、行がロックされます。ここで追加・削除できます。",
    listed: "掲載中",
    unfilled: "未入力",
    notUploaded: "未アップロード",
    minutes: "分",
  ...
  cms: {
    ...
    logo: "サイトロゴ",
    logoHint: "透過背景のロゴ（正方形または横長）を推奨します。未設定の場合はテキストロゴを表示します。",
    logoEmpty: "右側からロゴをアップロード",
    logoUpload: "ロゴをアップロード",
    logoChange: "ロゴを差し替え",
    logoRemove: "削除してテキストロゴに戻す",
    phone: "電話",
    email: "メール",
    hours: "営業時間",
