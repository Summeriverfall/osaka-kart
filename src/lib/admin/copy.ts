...
const zh: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/plans": { title: "套餐管理", lead: "编辑套餐，并用开关标记哪些附加项已包含在套餐内。" },
...
const en: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/inventory": { title: "Inventory", lead: "Available karts by date and time slot." },
    "/admin/vehicles": { title: "Vehicles", lead: "10 karts. Units in repair are pulled from that day’s sellable stock." },
    "/admin/plans": { title: "Plans", lead: "Edit plans and mark which add-ons are already included." },
...
const ja: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/inventory": { title: "在庫管理", lead: "日付×時間帯で利用可能な車両数を表示します。" },
    "/admin/vehicles": { title: "車両管理", lead: "整備中の車両は当日の販売在庫から除外されます。" },
    "/admin/plans": { title: "コース管理", lead: "コースを編集し、含まれるオプションをスイッチで指定します。" },
