...
const en: AdminCopy = {
  ...
  notify: {
    ...
    testSubject: "Furture Kart Osaka send test",
...
const ja: AdminCopy = {
  ...
  pages: {
    ...
    "/admin/settings/channels": { title: "流入元設定", lead: "流入元は管理画面のみ。OTAの手数料はレポートの入金計算に使います。" },
    "/admin/settings/stores": { title: "店舗管理", lead: "電話・住所・営業時間はサイトにも同期されます。" },
    "/admin/settings/email": { title: "メール設定", lead: "送信元を結び、お客さまの言語で確認・リマインド・返金の文面を編集します。" },
    "/admin/settings/send": { title: "メール設定", lead: "送信元を結び、お客さまの言語で確認・リマインド・返金の文面を編集します。" },
    "/admin/settings/mail": { title: "メール設定", lead: "送信元を結び、お客さまの言語で確認・リマインド・返金の文面を編集します。" },
  ...
  cms: {
    ...
    videoHint: "mp4 / webm、12MBまで。この端末に保存されます。",
    startAt: "開始秒",
    ...
    photo: "写真",
    homeFaq: "トップに出す",
    homeFaqHint: "オンにするとトップのFAQに出ます。FAQページは掲載中のすべて。",
    question: "質問",
    answer: "回答",
    sourceName: "媒体名",
    pressTitle: "見出し",
    ...
    brandName: "正式名称",
    brandShort: "短い名前（ナビ）",
    brandSuffix: "接尾辞（Osakaなど）",
    logo: "ロゴ",
    logoHint: "未設定なら文字ロゴのまま。正方形か横長が向いています。",
    phone: "電話",
    email: "メール",
    hours: "営業時間",
  ...
  reports: {
    ...
    revenueCol: "売上",
    cut: "手数料",
    cutHint: "手数料はすぐに入金へ反映し、流入元設定にも保存されます。",
    net: "入金",
  ...
  calendar: {
    ...
    weekHint: "色ブロックの高さはコース時間。ブロックを押すと予約詳細、日付列を押すと下の一覧がその日になります。",
    minutes: (n) => `${n}分`,
  },
  inventory: {
    free: "余裕",
  ...
  settings: {
    ...
    savePay: "設定を保存",
    channels: "流入元設定",
    channelLead: "流入元は管理画面のみ。OTAの手数料はレポートの入金計算に使います。",
    channelCut: "手数料%",
